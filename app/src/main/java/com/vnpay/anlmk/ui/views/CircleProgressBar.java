...
public class CircleProgressBar extends AppCompatImageView {
    ...
    private static final int DEFAULT_CIRCLE_DIAMETER = 5;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgressColor = a.getColor(R.styleable.CircleProgressBar_progress_color, DEFAULT_CIRCLE_BG_LIGHT);

        mColors = new int[]{mProgressColor,
                0xff9b1b1c, 0xff5fbee3, 0xffc6a56a,
                0xff0f5f14, 0xff093a0c, 0xff3b5998,
                0xff404040, 0xff974710, 0xff791304,
                0xffebb800, 0xffe09036, 0xff42474b};

        mInnerRadius = a.getDimensionPixelOffset(R.styleable.CircleProgressBar_inner_radius, -1);

        mProgressStokeWidth = a.getDimensionPixelOffset(R.styleable.CircleProgressBar_progress_stoke_width,
        ...
        mTextSize = a.getDimensionPixelOffset(R.styleable.CircleProgressBar_progress_text_size,
                (int) (DEFAULT_TEXT_SIZE * density));
        mTextColor = a.getColor(R.styleable.CircleProgressBar_progress_text_color, Color.BLACK);

        mShowArrow = a.getBoolean(R.styleable.CircleProgressBar_show_arrow, false);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!elevationSupported()) {
            setMeasuredDimension(getMeasuredWidth() + mShadowRadius * 1, getMeasuredHeight() + mShadowRadius * 1);
        }
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (getBackground() == null && mCircleBackgroundEnabled) {
            ...
            if (elevationSupported()) {
                ...
                setLayerType(LAYER_TYPE_SOFTWARE, mBgCircle.getPaint());
