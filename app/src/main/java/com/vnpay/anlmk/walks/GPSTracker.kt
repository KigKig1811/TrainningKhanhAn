...
class GPSTracker private constructor(context: Context) : LocationListener {
    ...
    internal var callback: LocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult?) {
            ...
            if (locationResult != null && locationResult!!.lastLocation != null) {
                Log.d("A", " P: " + locationResult!!.lastLocation.toString())
    ...
    companion object {
        ...
        fun showSettingsAlert(mContext: Context) {
            ...
            alertDialog.setPositiveButton(
                mContext.getString(R.string.setting)
            ) { _, _ ->
