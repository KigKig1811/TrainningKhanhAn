...
public class MoneyUSReader implements IMoneyReader {
    AbstractProcessor processor;
    private String ccy;

    public static MoneyUSReader newInstance() {
        MoneyUSReader moneyReader = new MoneyUSReader();
        return moneyReader;
    }
    ...
    public String convert(String value) {
        ...
        return processor.getName(value);
    }
    ...
    public void setCcy(String ccy) {
        if ("usd".equalsIgnoreCase(ccy)) {
            this.ccy = " dollards";
        } else if ("eur".equalsIgnoreCase(ccy)) {
            this.ccy = " euro";
        } else if ("gbp".equalsIgnoreCase(ccy)) {
            this.ccy = " GBP";
        } else
            this.ccy = " vnd";
    }
     ...
     */
    public Scale SCALE = Scale.SHORT;
    ...
    public class DefaultProcessor extends AbstractProcessor {
        ...
        private String UNION_AND = "and";

        private String ZERO_TOKEN = "zero";
        ...
        public String getName(String value) {
            ...
            return UIModel.getInstance().Captain(name);
        }
